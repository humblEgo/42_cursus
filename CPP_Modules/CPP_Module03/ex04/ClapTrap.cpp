...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/24 22:14:30 by iwoo              #+#    #+#             */
/*   Updated: 2020/08/24 22:14:30 by iwoo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
: hit_points_(0), max_hit_points_(0), energy_points_(0),
...
void ClapTrap::setMaxHitPoints(unsigned int max_hit_point)
{
    max_hit_points_ = max_hit_point;
}

void ClapTrap::setHitPoints(unsigned int hit_point)
{
    if (hit_point > max_hit_points_)
    {
        std::cout<<"Hit point cannot exceed max_Hit_point.";
        std::cout<<"Hit_point is adjusted to max_Hit_point."<<std::endl;
    }
    raiseHitPoints(hit_point);
}
